...
public class OtusHttpCrudServer {
    ...
    static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            } else if ("/get-by-login".equals(path)) {
                routeRead(t);
                System.out.println("matched");
            } else if ("/get-by-id".equals(path)) {
                routeUserById(t);
                System.out.println("matched");
    ...
    static private void routeUserById(HttpExchange t) throws IOException {
        System.out.println("Read request accepted");
        Map<String, String> q = queryToMap(t.getRequestURI().getQuery());
        String id = q.get("id");
        String r;
        ...
        try {
            ...
            System.out.println("send headers");
            t.sendResponseHeaders(code, r.length());
            System.out.println("success");
        } catch (Throwable e) {
            System.out.println("error: " + e.getMessage());
            r = "internal server error";
